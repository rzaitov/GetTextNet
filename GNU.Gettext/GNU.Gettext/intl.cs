...
namespace GNU.Gettext
{
    ...
    public class GettextResourceManager : ResourceManager
    {
		...
		/// </summary>
		public GettextResourceManager(PathResolver pathResolver)
            : this(Assembly.GetCallingAssembly(), pathResolver)
        {
        }
		...
		/// </param>
		public GettextResourceManager(Assembly assembly, PathResolver pathResolver)
        ...
        ///                        name</param>
		public GettextResourceManager(String baseName, PathResolver pathResolver)
        ...
        /// <param name="baseName">the resource name, also the assembly base
        ///                        name</param>
		public GettextResourceManager(String baseName, Assembly assembly, PathResolver pathResolver)
		...
		/// </param>
		public static string GetEmbededSatelliteAssemblyName(string resourceName)
		{
			return String.Format("{0}.resources.dll", resourceName);
		}
        ...
        // mono-0.28.
        private static Assembly GetSatelliteAssembly(Assembly assembly, String resourceName, CultureInfo culture, PathResolver pathResolver)
        {
			string satelliteExpectedLocation = pathResolver.Resolve(Path.GetDirectoryName(assembly.Location), resourceName, culture);
            ...
            string embeddedResourceId = String.Format("{0}.{1}.{2}",
                assembly.GetName().Name, culture.Name, GetEmbededSatelliteAssemblyName(resourceName));
        ...
        /// <returns></returns>
        public static string MakeResourceSetClassName(CultureInfo culture)
        {
                ...
                lock (this)
                {
                    ...
                    if (result == null)
                    {
                        ...
                        else
                        {
                            ...
                            try
                            {
                                satelliteAssembly = GetSatelliteAssembly(MainAssembly, BaseName, culture, _pathResolver);
                            }
