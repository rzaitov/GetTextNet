...
//                String.Format("{0}.{1}.resources.cs", Options.BaseName, Options.Locale.Name));
		...
		private void Generate()
		{
			...
			{
				cw.WriteLine("namespace GNU.Gettext");
				cw.WriteLine("{");
				cw.Indent++;
			}
		...
		private void Compile()
		{
			...
			string outputName = Path.Combine(AssemblyOutDir, Options.OutFile);

			p.StartInfo.Arguments = String.Format(
				"-target:library -out:\"{0}\" -lib:\"{1}\" -reference:GNU.Gettext.dll -optimize+ \"{2}\"",
				outputName,
