...
namespace GNU.Gettext.WinForms
{
	...
	public class Localizer
	{
		...
		public Localizer(Control rootControl, string resourceBaseName)
			: this(rootControl, new GettextResourceManager(resourceBaseName, new SingleNameSeparateFolderPathResolver()), null)
		{
		}
		...
		{
			Localizer loc = new Localizer(control, new GettextResourceManager(PathResolver.Default), originalTextStore);
			loc.Revert();
		}
